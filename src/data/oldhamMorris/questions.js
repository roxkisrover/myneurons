export const omQuestionsData = [
  ...
  },
  {
    id: 10,
    target: [10],
    text: 'Я не ощущаю вины за свои прошлые поступки.',
  },
  {
    id: 11,
    target: [0],
  ...
  },
  {
    id: 21,
    target: [10],
    text: 'Я часто намеренно говорю неправду.',
  },
  {
    id: 22,
    target: [0],
  ...
  },
  {
    id: 24,
    target: [2, 4],
    text: 'У меня нет близких друзей кроме, возможно, некоторых членов моей семьи.',
  },
  {
    id: 25,
    target: [0],
  ...
  },
  {
    ...
    target: [9],
    text:
      'Я чувствую дискомфорт от мысли, что меня может прилюдно критиковать кто-то из коллег, поэтому я предпочитаю работать в одиночку или в небольшом коллективе.',
  },
  {
    id: 43,
    target: [10],
    text:
      'Мне нравится неформальный стиль жизни, где я могу нарушать правила и законы, избегая за это наказания.',
  },
  {
    id: 44,
    target: [0],
  ...
  },
  {
    ...
    target: [1],
    text:
      'Мне кажется, что некоторые люди дразнят и оскорбляют меня лишь для того, чтобы вывести из себя.',
  },
  {
    id: 46,
    target: [2],
  ...
  },
  {
    ...
    target: [3],
    text:
      'Моё настроение весьма переменчиво: даже мелочи могут вывести меня из себя. В течение нескольких часов я могу испытать и радость, и грусть, и раздражение с тревогой.',
  },
  {
    id: 59,
    target: [4],
  ...
  },
  {
    ...
    target: [7],
    text:
      'Я много раз придавал взаимоотношениям больше значения, чем они того стоят. Это причиняет мне боль.',
  },
  {
    id: 63,
    target: [8],
  ...
  },
  {
    ...
    target: [9],
    text:
      'Я боюсь потерпеть неудачу, поэтому не люблю рисковать и принимать нестандартные решения.',
  },
  {
    id: 65,
    target: [10],
  ...
  },
  {
    ...
    target: [3, 10],
    text:
      'Я люблю действовать спонтанно и по вдохновению. Я могу совершать бессмысленные покупки, нарушать правила дорожного движения, переедать и даже сильно напиваться. Так мне интереснее жить, хотя я и признаю, что порой это имеет негативные последствия.',
  },
  {
    id: 70,
    target: [0],
  ...
  },
  {
    ...
    target: [9],
    text:
      'Мне часто становится не по себе, когда нужно говорить с вышестоящим лицом, например, с начальством, даже если в целом оно благосклонно ко мне.',
  },
];
