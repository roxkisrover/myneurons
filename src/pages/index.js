...
const Home = () => (
  <React.Fragment>
    <SEO title="Главная страница" keywords={['тесты', 'психология']} />

    <div className={styles.wrapper}>
      <div className={styles.container}>
        <Row gutter={24}>
          <Col md={{ span: 12 }}>
            <h1 className={styles.title}>myneurons</h1>
          ...
          <Col md={{ span: 12 }}>
            <div className={styles.scroll}>
              ...
              <Link className="ant-btn ant-btn-primary ant-btn-sm" to="/oldham-morris">
                Начать тестирование
              </Link>
              ...
              <Link className="ant-btn ant-btn-primary ant-btn-sm" disabled to="/">
